...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', action = 'store', dest = 'output_file', help = "output super resolution 10m data file")
    ...
    outdata = driver.Create(args.output_file, ds10.RasterXSize, ds10.RasterXSize, 12, gdal.GDT_UInt16)
