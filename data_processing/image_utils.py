...
from utils import unzip_directory, unzip_folder, print_color, delete_directory, find_subfolders, zip_and_remove_folder
...
def resample_raster(input_path, output_path, new_pixel_size=None, reference_raster_path=None):
    with rasterio.open(input_path) as src:
        ...
        with rasterio.open(scl_mask_path) as scl_mask_src:
            ...
            with rasterio.open(aot_mask_path) as aot_mask_src:
                ...
                with rasterio.open(cloud_mask_path) as cloud_mask_src:
                    ...
                    profile = src.profile
                    profile.update(count=src.count, descriptions=band_descriptions, driver='GTiff', dtype=rasterio.uint16)
