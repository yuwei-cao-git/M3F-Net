...
def run_l2a_process(input_folder, output_folder):
    ...
    l2a_process_cmd = f"C:/Users/ycao68/Sen2Cor-02.11.00-win64/L2A_Process.bat {input_folder} --output_dir {output_folder}"
...
for season in ["spring"]:
    input_folder = f"{directory}/{season}/raw/second"
    unzip_folder = f"{input_folder}/unzip"
    output_folder = f"{input_folder}/L2A_S"
