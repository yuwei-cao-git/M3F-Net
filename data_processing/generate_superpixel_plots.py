...
if __name__ == "__main__":
    ...
    for resolution in resolutions:
        ...
        polygons_gdf = gpd.read_file(
            f"/mnt/d/Sync/research/tree_species_estimation/tree_dataset/rmf/rmf_fri/superpixel_{resolution}.gpkg"
        )
        ...
        plots.to_file(
            f"/mnt/d/Sync/research/tree_species_estimation/tree_dataset/rmf/rmf_plots/fusion/superpixel_plots_{resolution}.gpkg"
        )
