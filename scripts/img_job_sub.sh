...
#SBATCH --output=./output/${next_output_dir}/%N-%j.out    # Specify output file format generated by python script
#SBATCH --error=./output/${next_output_dir}/%N-%j.error
...
srun python train.py --data_dir '../data' --resolution 20 --log_name 'ResUnet_S4_20m_MF' --num_epoch 200 --batch_size 48 --mode 'img' --use_mf --use_residual

cd $SLURM_TMPDIR
tar -cf ~/scratch/output/${next_output_dir}/checkpoints.tar work/M3F-Net/logs/checkpoints/*
tar -cf ~/scratch/output/${next_output_dir}/wandblogs.tar work/M3F0Bet/wandb/*
