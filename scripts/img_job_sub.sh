...
srun python train.py --init_method tcp://$MASTER_ADDR:3456 --data_dir '../data' --resolution 20 --log_name 'ResUnet_S4_20m_MF' --num_epoch 200 --batch_size 48 --mode 'img' --use_mf --use_residual
