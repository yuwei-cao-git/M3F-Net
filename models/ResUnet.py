...
class ResUnet(nn.Module):
    def __init__(self, n_channels=52, n_classes=9):
        ...
        self.residual_block_d1 = ResidualBlock(in_channels=f[4]+f[3], out_channels=f[3])
        self.residual_block_d2 = ResidualBlock(in_channels=f[3]+f[2], out_channels=f[2])
        self.residual_block_d3 = ResidualBlock(in_channels=f[2]+f[1], out_channels=f[1])
        self.residual_block_d4 = ResidualBlock(in_channels=f[1]+f[0], out_channels=f[0])
